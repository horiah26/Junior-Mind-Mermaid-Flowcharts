...
namespace Flowcharts.Tests
{
    public class GridTests
    {
        ...
        public void GridResizesOnlyRows()
        {
            ...
            Assert.Equal((14, 10), grid.GetSize());
        }
