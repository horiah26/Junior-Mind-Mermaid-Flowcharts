...
{
    class ShapeStadiumInOutCalculator
    {
        ...
        public ShapeStadiumInOutCalculator(IOrientation orientation, double xPos, double yPos, double height, double length, string[] lines)
        {
