...
{
    internal class ShapeTrapezoidPointsCalculator
    {
        ...
        public ShapeTrapezoidPointsCalculator(double xPos, double yPos, double height, double length, string[] lines, double gap)
        {
            this.xPos = xPos;
            this.yPos = yPos;
            this.height = height;
