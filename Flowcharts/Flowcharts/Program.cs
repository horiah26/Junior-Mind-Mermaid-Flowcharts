namespace Flowcharts
{
    class Program
    {
        static void Main()
        {
            ...
            //flowchart.AddPair(("A1", "A", "Rectangle"), ("A2", "B", "Rectangle"), "Arrow");
            //flowchart.AddPair(("A2", "A", "Rectangle"), ("A3", "C", "Rectangle"), "Arrow");
            //flowchart.AddPair(("A2", "A", "Rectangle"), ("A4", "D", "Rectangle"), "Arrow");
            //flowchart.AddPair(("A2", "A", "Rectangle"), ("A5", "E", "Rectangle"), "Arrow");
            ...
            flowchart.AddPair("A3", ("At615", "Is service to be provided by an independednt contrsadactor?", "Rectangle"), "Arrow", "Yes");
            flowchart.AddPair("A4", ("A2"), "BackArrow");
