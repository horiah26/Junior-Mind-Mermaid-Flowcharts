    ...
    internal class ShapeBannerIO
    {
        ...
        public IOPoints GetIO()
        {
            ...
            if (typeof(OrientationLeftRight) == orientation.GetType())
            {
                ...
                BackArrowEntry = (xPos + length / 1.25 - 2, yPos );
            }
            ...
            else if (typeof(OrientationTopDown) == orientation.GetType())
            {
                ...
                BackArrowEntry = (xPos + length / 2 - length / 10 - 15, yPos + height / 2);
            }
            else if (typeof(OrientationDownTop) == orientation.GetType())
            {
                ...
                BackArrowEntry = (xPos + length / 2 - length / 10 - 15, yPos - height / 2 - 20);
            }
            else
            {
