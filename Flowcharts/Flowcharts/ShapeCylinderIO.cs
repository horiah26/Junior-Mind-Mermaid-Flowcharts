    ...
    internal class ShapeCylinderIO
    {
        ...
        public IOPoints GetIO()
        {
            ...
            if (typeof(OrientationLeftRight) == orientation.GetType())
            {
                ...
                BackArrowIn = (xPos + length, yPos + height / 2);
            }
            else if (typeof(OrientationRightLeft) == orientation.GetType())
            {
                ...
                BackArrowIn = (xPos - 20, yPos + height / 2);
            }
            else if (typeof(OrientationTopDown) == orientation.GetType())
            {
                ...
                BackArrowIn = (xPos + length / 2, yPos + height + 10);
            }
            else if (typeof(OrientationDownTop) == orientation.GetType())
            {
                ...
                BackArrowIn = (xPos + length / 2, yPos - height + numberOfLines * 15 - 20);
            }
            else
            {
