...
namespace Flowcharts
{
    public class Flowchart
    {
        ...
        public void AddPair((string key, string text, string shape, Subsystem subsystem) dataElement1, (string key, string text, string shape) dataElement2, string arrowName, string text = null)
        {
            var element1 = Factory.Element(dataElement1.key, dataElement1.text, dataElement1.shape);
            var element2 = Factory.Element(dataElement2.key, dataElement2.text, dataElement2.shape);
        ...
        public void AddPair((string key, string text, string shape) dataElement1, (string key, string text, string shape, Subsystem subsystem) dataElement2, string arrowName, string text = null)
        {
            var element1 = Factory.Element(dataElement1.key, dataElement1.text, dataElement1.shape);
            var element2 = Factory.Element(dataElement2.key, dataElement2.text, dataElement2.shape);
